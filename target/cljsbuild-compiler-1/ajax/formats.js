...
var G__6639 = request;
var G__6640 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__6639,G__6640) : ajax.formats.get_format.call(null,G__6639,G__6640));
} else {
...
return cljs.core.some(((function (accept){
return (function (p1__6641_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__6641_SHARP_);
});})(accept))
,accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__6642){
...
var request = map__6643__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6643__$1,cljs.core.cst$kw$response_DASH_format);
var content_type = ajax.util.get_content_type(response);
var accepted_format_QMARK_ = ((function (content_type,map__6643,map__6643__$1,request,response_format){
...
});})(content_type,map__6643,map__6643__$1,request,response_format))
;
...
var fexpr__6645 = cljs.core.cst$kw$read.cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__6645.cljs$core$IFn$_invoke$arity$1 ? fexpr__6645.cljs$core$IFn$_invoke$arity$1(response) : fexpr__6645.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__6647){
var map__6648 = p__6647;
var map__6648__$1 = (((((!((map__6648 == null))))?(((((map__6648.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6648.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6648):map__6648);
var request = map__6648__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6648__$1,cljs.core.cst$kw$response_DASH_format);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(((function (formats,map__6648,map__6648__$1,request,response_format){
return (function (p1__6646_SHARP_){
return ajax.formats.get_accept_entries(request,p1__6646_SHARP_);
});})(formats,map__6648,map__6648__$1,request,response_format))
