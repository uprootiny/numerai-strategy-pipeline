...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__6901 = cljs.core.second(format);
var G__6902 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__6901,G__6902) : ajax.easy.keyword_response_format_element.call(null,G__6901,G__6902));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__6903 = format;
var G__6903__$1 = (((G__6903 instanceof cljs.core.Keyword))?G__6903.fqn:null);
switch (G__6903__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__6905_SHARP_){
return ajax.easy.keyword_response_format_element(p1__6905_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__6906){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6907__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6907__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6907__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__6907,map__6907__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__6909){
var vec__6910 = p__6909;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6910,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6910,(1),null);
var fexpr__6913_6914 = (cljs.core.truth_(ok)?h:e);
(fexpr__6913_6914.cljs$core$IFn$_invoke$arity$1 ? fexpr__6913_6914.cljs$core$IFn$_invoke$arity$1(result) : fexpr__6913_6914.call(null,result));
...
;})(h,e,map__6907,map__6907__$1,handler,error_handler,finally$))
});
/**
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__6915){
var map__6916 = p__6915;
var map__6916__$1 = (((((!((map__6916 == null))))?(((((map__6916.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6916.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6916):map__6916);
var opts = map__6916__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6916__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6916__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6916__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6916__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6916__$1,cljs.core.cst$kw$body);
