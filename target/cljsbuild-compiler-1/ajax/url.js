...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("/",(function (){var fexpr__5580 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace,cljs.core.name);
return (fexpr__5580.cljs$core$IFn$_invoke$arity$1 ? fexpr__5580.cljs$core$IFn$_invoke$arity$1(key) : fexpr__5580.call(null,key));
})());
} else {
...
ajax.url.key_value_pair_to_str = (function ajax$url$key_value_pair_to_str(p__5581){
...
var vec_key_encode = (function (){var G__5585 = (function (){var or__4131__auto__ = vec_strategy;
...
var G__5585__$1 = (((G__5585 instanceof cljs.core.Keyword))?G__5585.fqn:null);
switch (G__5585__$1) {
case "java":
return ((function (G__5585,G__5585__$1){
return (function (k){
return null;
});
;})(G__5585,G__5585__$1))
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5585__$1)].join('')));
 ...
 */
ajax.url.param_to_key_value_pairs = (function ajax$url$param_to_key_value_pairs(vec_key_transform,prefix,p__5587){
var vec__5588 = p__5587;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5588,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5588,(1),null);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_key,clojure.string.join.cljs$core$IFn$_invoke$arity$2("/",(function (){var fexpr__5591 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace,cljs.core.name);
return (fexpr__5591.cljs$core$IFn$_invoke$arity$1 ? fexpr__5591.cljs$core$IFn$_invoke$arity$1(value) : fexpr__5591.call(null,value));
})())], null)], null);
} else {
...
ajax.url.url_request_format.cljs$core$IFn$_invoke$arity$1 = (function (p__5594){
var map__5595 = p__5594;
var map__5595__$1 = (((((!((map__5595 == null))))?(((((map__5595.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5595.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5595):map__5595);
var vec_strategy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5595__$1,cljs.core.cst$kw$vec_DASH_strategy);
