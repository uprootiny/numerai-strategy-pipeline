...
var G__6233_6236 = reagent.impl.template.prop_name_cache;
var G__6234_6237 = cljs.core.name(k);
var G__6235_6238 = v;
goog.object.set(G__6233_6236,G__6234_6237,G__6235_6238);
...
var G__6239 = o;
var G__6240_6243 = G__6239;
var G__6241_6244 = reagent.impl.template.cached_prop_name(k);
var G__6242_6245 = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v));
goog.object.set(G__6240_6243,G__6241_6244,G__6242_6245);
...
while (G__6247__i < G__6247__a.length) {G__6247__a[G__6247__i] = arguments[G__6247__i + 0]; ++G__6247__i;}
  args = new cljs.core.IndexedSeq(G__6247__a,0,null);
} 
...
if((temp__5737__auto__ == null)){
var v = reagent.impl.util.dash_to_prop_name(k);
var G__6249_6252 = reagent.impl.template.custom_prop_name_cache;
var G__6250_6253 = cljs.core.name(k);
var G__6251_6254 = v;
goog.object.set(G__6249_6252,G__6250_6253,G__6251_6254);
...
var G__6255 = o;
var G__6256_6259 = G__6255;
var G__6257_6260 = reagent.impl.template.cached_custom_prop_name(k);
var G__6258_6261 = reagent.impl.template.convert_prop_value(v);
goog.object.set(G__6256_6259,G__6257_6260,G__6258_6261);
...
while (G__6263__i < G__6263__a.length) {G__6263__a[G__6263__i] = arguments[G__6263__i + 0]; ++G__6263__i;}
  args = new cljs.core.IndexedSeq(G__6263__a,0,null);
} 
...
var G__6265 = props;
var G__6265__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6265,cljs.core.cst$kw$id,id):G__6265);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6265__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__6265__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__6266 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6266,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__6266;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__6267){
var map__6268 = p__6267;
var map__6268__$1 = (((((!((map__6268 == null))))?(((((map__6268.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6268.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6268):map__6268);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6268__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__6268,map__6268__$1,on_write){
return (function (){
...
});})(node_value,map__6268,map__6268__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change(this$,on_change,p1__6270_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__6273 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6273,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6273,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6273,(2),null);
...
var temp__5739__auto___6277 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___6277 == null)){
} else {
var key_6278 = temp__5739__auto___6277;
jsprops.key = key_6278;
}
...
var temp__5739__auto___6279 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___6279 == null)){
} else {
var key_6280 = temp__5739__auto___6279;
jsprops.key = key_6280;
}
...
var G__6281 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__6281) : reagent.impl.template.as_element.call(null,G__6281));
} else {
var temp__5739__auto___6282 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___6282 == null)){
} else {
var key_6283 = temp__5739__auto___6282;
jsprops.key = key_6283;
}
...
var G__6285 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__6285)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__6285)){
return x;
} else {
...
var len__4730__auto___6288 = arguments.length;
var i__4731__auto___6289 = (0);
while(true){
if((i__4731__auto___6289 < len__4730__auto___6288)){
args__4736__auto__.push((arguments[i__4731__auto___6289]));

var G__6290 = (i__4731__auto___6289 + (1));
i__4731__auto___6289 = G__6290;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq6286){
var G__6287 = cljs.core.first(seq6286);
var seq6286__$1 = cljs.core.next(seq6286);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__6287,seq6286__$1);
});
...
break;
default:
var G__6293 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__6293;
continue;
...
var ctx = ({});
var vec__6295 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6295,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6295,(1),null);
...
var G__6298 = (cljs.core.count(argv) - first_child);
switch (G__6298) {
case (0):
...
break;
case (1):
var G__6299 = component;
var G__6300 = jsprops;
var G__6301 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__6299,G__6300,G__6301) : reagent.impl.template.global$module$react.createElement.call(null,G__6299,G__6300,G__6301));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__6298){
