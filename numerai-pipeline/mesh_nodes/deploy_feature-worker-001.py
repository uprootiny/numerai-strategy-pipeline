...
class MeshNodeWorker:
    def __init__(self):
        self.node_id = "feature-worker-001"
...
if __name__ == "__main__":
    ...
    print(f"🚀 Starting mesh node {worker.node_id} on port 9004")
    app.run(host="localhost", port=9004, debug=False)
